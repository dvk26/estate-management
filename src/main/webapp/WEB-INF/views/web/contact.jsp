            ...
            <div class="row">
                ...
                <div class="col-12 col-md-6">
                    ...
                    <form id="contactForm">
                        <div class="row">
                            <div class="col">
                                <input id="fullName" type="text" name="fullName" class="form-control" placeholder="Họ và tên">
                            </div>
                            <div class="col">
...
<script>
    $("#submitBtn").click(function(e){
        ...
        console.log(object); // In ra đối tượng chứa nội dung của formif
        if(object['fullName']!=''&&object['phone']!=''){
